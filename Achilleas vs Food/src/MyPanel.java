...
public class MyPanel extends JPanel implements ActionListener
{
	...
	MyPanel()
	{
		...
		Burger = new ImageIcon("Burger.png").getImage();
		Achilleas = new ImageIcon("Achilleas.png").getImage(); //Creates (gets) an image out of our imageIcon
		
		Space = new ImageIcon("Space.jpg").getImage();  //Creates (gets) an image out of our imageIcon
